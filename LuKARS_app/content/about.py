...
st.markdown(
    """
    The Module **Karst Flow Conceptual Modelling** introduces the main characteristics of karst systems and the principles of conceptual hydrological modelling, with a focus on the semi-distributed **LuKARS flow model**. Interactive examples and exercises are used to explore how model structure and parameters control storage, flow pathways, and spring discharge.
    """
)
...
st.markdown(
    """
    The Module **Karst Flow Conceptual Modelling** was developed by Beatrice Richieri and Thomas Reimann as a Streamlit application and adapted to the interactive education format for Eurokarst 2026. The module guides users from basic concepts of karst hydrology and conceptual modelling to the structure and application of the LuKARS model.
    """
)
